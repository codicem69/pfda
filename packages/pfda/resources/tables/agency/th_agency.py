...
class ViewFromAgency(BaseComponent):
    ...
    def th_struct(self,struct):
        ...
        r.fieldcell('tariffe_id',edit=dict(remoteRowController=True,validate_notnull=True,
                                            ...
                                            condition_cod='%Ag%',hasDownArrow=True)) #edit=True, hasDownArrow=True,rowcaption='$codice,$descrizione')
        ...
        r.fieldcell('pu')
        r.fieldcell('totagency', totalize=True)
    ...
    def th_remoteRowController(self,row=None,field=None,**kwargs):
        ...
        row['totagency'] = decimalRound(totprest - sconto)
        return row
