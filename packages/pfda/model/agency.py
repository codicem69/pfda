...
class Table(object):
    def config_db(self,pkg):
        ...
        tbl.column('tariffe_id',size='22',name_long='tariffa agency').relation('tariffe.id',relation_name='tariffe_agency', mode='foreignkey', onDelete='setnull')
        tbl.column('quantita',dtype='I',name_long='Quantità')
        tbl.column('sconto',dtype='N',size='10,2',name_long='Sconto %')
