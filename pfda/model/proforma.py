...
class Table(object):
    def config_db(self,pkg):
        ...
        #tbl.column('tributi_cp',size='22',name_long='tributicp').relation('tributicp.id',relation_name='tributicp', mode='foreignkey', onDelete='raise')
        ...
        tbl.aliasColumn('bandiera',name_long='Bandiera',relation_path='@imbarcazione_id.bandiera')
        tbl.aliasColumn('loa',name_long='Loa',relation_path='@imbarcazione_id.loa')
        tbl.aliasColumn('gt',name_long='GT',relation_path='@imbarcazione_id.gt')
